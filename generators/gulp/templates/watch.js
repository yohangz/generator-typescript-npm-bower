 ...
 * Clean js tmp -> run tslint, jshint<% if (styles) { if (scss) { -%> and sass lint<% } else { -%> and css lint<% }} -%> -> temporary watch scripts, watch build scripts<% if (styles) { if (scss) { -%> and watch scss scripts<% } else { -%> and watch css scripts<% }} -%>.
